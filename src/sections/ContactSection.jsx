...
export default function ContactSection() {
  ...
  return (
    <section id="contact" tabIndex="-1" className="portfolio-section contact-section relative h-[1080px] overflow-hidden bg-surface-light outline-none" aria-labelledby="contact-title">
      ...
      <div className="contact-section__content absolute left-[160px] top-[154px] h-[650px] w-[1600px]">
        ...
        <div className="contact-section__monitor section-reveal section-reveal--delay-3 absolute left-[750px] top-0 h-[248px] w-[850px] rounded-monitor bg-text-primary">
        ...
        <div className="contact-section__timeline section-reveal section-reveal--delay-4 absolute left-[720px] top-[290px] w-[880px]">
      ...
      <footer className="contact-section__footer section-reveal section-reveal--delay-4 absolute left-0 top-[950px] h-[71px] w-full border-t border-surface-grey text-body">
